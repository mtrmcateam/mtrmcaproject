...
@section('head')
@parent
<title>Browse Flatmates | Mycollegeadda</title>
@stop
@section('select_category')
<a href="">Flatmates <i class="uk-icon-caret-down"></i></a>
...
<div class="uk-container uk-container-center">
    ...
    <article class="uk-article uk-width-medium-8-10">
        ...
        <h2 class="mca-page-title">Find Flatmates</h2>
        ...
        @include('utility.ajax.flatmates')
        </div>
    </article>
    </div>
</div>
...
<script type="text/javascript">
    $('#searchForm').on('submit',function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "{{ URL::route('getFlatmatesSearchResultAJAX') }}",
