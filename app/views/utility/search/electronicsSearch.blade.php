...
@section('head')
@parent
<title>Browse Electronics | Buy Used Electronics | Mycollegeadda</title>
@stop
@section('select_category')
<a href="">Electronics <i class="uk-icon-caret-down"></i></a>
...
<div class="uk-container uk-container-center">
    ...
    <article class="uk-article uk-width-medium-8-10">
        ...
        <h2 class="mca-page-title">Electronics for sale</h2>
        ...
        @include('utility.ajax.electronics')
        </div>
    </article>
    </div>
</div>
...
<script>
    ...
    function getProducts(page){
        $('.spinner').show();
        $.ajax({
            url:'ajax/electronics?page='+ page
        }).done(function(data){
            $('.spinner').hide();
...
<script type="text/javascript">
    $('#searchForm').on('submit',function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "{{ URL::route('getElectronicsSearchResultAJAX') }}",
