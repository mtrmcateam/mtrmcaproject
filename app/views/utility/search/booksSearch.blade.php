...
@section('head')
@parent
<title>Browse Books | Buy Used Books | Mycollegeadda</title>
@stop
@section('select_category')
<a href="">Books <i class="uk-icon-caret-down"></i></a>
...
<div class="uk-container uk-container-center">
    ...
    <article class="uk-article uk-width-medium-8-10">
        ...
        <h2 class="mca-page-title">Books for sale</h2>
...
<script type="text/javascript">
    $('#searchForm').on('submit',function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "{{ URL::route('getBooksSearchResultAJAX') }}",
