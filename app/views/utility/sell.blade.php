...
@section('head')
@parent
<title>Mycollegeadda | Sell &amp; Connect with your college folks</title>
...
<div style="background: rgba(0, 0, 0, 0.55);">  
    ...
    <div class="uk-position-cover uk-flex uk-flex-center uk-flex-top uk-margin-large-top">
      ...
      <div class="uk-grid">
        ...
        <h2 class="uk-contrast">Post your ad for free on mycollegeadda</h2>
        <h3 class="uk-contrast">Want to sell used goods across your campus ? Sell here...</h3>
        <div id="outer" class="uk-container-center uk-margin-large-top">
            <a class="uk-button uk-button-white uk-button-large" href="{{ URL::route('getSellBooks')}}"><i class="uk-icon-book"></i> Books</a>
            <a class="uk-button uk-button-white uk-button-large" href="{{ URL::route('getSellNotes')}}"><i class="uk-icon-newspaper-o"></i> Notes</a>
            <a class="uk-button uk-button-white uk-button-large" href="{{ URL::route('getSellElectronics')}}"><i class="uk-icon-fax"></i> Electronics</a>
            <a class="uk-button uk-button-white uk-button-large" href="{{ URL::route('getSellCarPool')}}"><i class="uk-icon-automobile"></i> Car Pool</a>
            <a class="uk-button uk-button-white uk-button-large" href="{{ URL::route('getSellFlatmates')}}"><i class="uk-icon-home"></i> Flatmates</a>
        </div>
      </div>
    </div>
    </div>
