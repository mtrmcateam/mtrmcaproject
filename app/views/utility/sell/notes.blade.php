...
@section('head')
@parent
<title>Sell Notes | Mycollegeadda</title>
...
<section class="uk-container uk-container-center">
      ...
      <article class="uk-article uk-width-medium-8-10">
        <ul class="uk-breadcrumb">
            ...
            <li class="uk-active"><span>Notes</span></li>
        </ul>
          <h2> Post Ad to Sell your Notes</h2>
          <p class="uk-article-lead uk-text-primary">Fill Details of the Notes to let Buyer find you</p>
          <div class="uk-panel uk-panel-box uk-panel-box-secondary">
            <div class="uk-text-danger uk-text-right">*Mandatory Fields</div>
          
          <form class="uk-form uk-form-horizontal" method="post" enctype="multipart/form-data" action="{{ URL::route('postSellNotes')}}">
            ...
            <div class="uk-form-row">
                  ...
                  <div class="uk-form-controls">
                    <input type="text" id="subject" class="uk-form-large uk-width-medium-1-2{{ ($errors->has('subject')) ? ' uk-form-danger' : ''}}" name="subject"{{ (Input::old('subject'))? 'value="'. e(Input::old('subject')) . '"' : ''}} id="subject" placeholder="Enter name of subject" data-uk-tooltip="{pos:'right',offset:20}" title="You can post an Ad for xerox of notes, handwritten notes, soft copy of notes or notes in any form">
            ...
            <div class="uk-form-row">
                <label for="category" class="uk-form-label">Notes Type</label>
                <div class="uk-form-controls">
            ...
            <div class="uk-form-row">
                  <label for="item_condition" class="uk-form-label">Notes Condition<span class="uk-text-danger">*</span></label>
          ...
          <div class="uk-form-row">
                  ...
                  <div class="uk-form-controls">
                    <input type="text"  class="uk-form-large uk-width-medium-1-2{{ ($errors->has('selling_price')) ? ' uk-form-danger' : ''}}" name="selling_price"{{ (Input::old('selling_price'))? 'value="'. e(Input::old('selling_price')) . '"' : ''}} id="selling_price" placeholder="Enter price on which you want to sell notes">
