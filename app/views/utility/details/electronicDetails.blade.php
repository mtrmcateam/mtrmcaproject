...
<section class="uk-container uk-container-center">
      ...
      <article class="uk-article uk-width-medium-8-10">
        <ul class="uk-breadcrumb">
            ...
            <li><a href="{{ URL::route('getElectronicsSearchQueryResult')}}">Electronics</a></li>
        ...
        <div class="uk-panel uk-panel-box uk-panel-box-secondary">
            ...
            <ul class="uk-grid uk-text-justify uk-container-center uk-width-9-10" data-uk-grid-margin="">
                ...
                <li class="uk-width-medium-1-3 uk-grid-margin"><h5 class="uk-text-muted"><b>Model No.</b></h5>{{ $product->model_no }}</li>
                <li class="uk-width-medium-1-3"><h5 class="uk-text-muted"><b>Posted by</b></h5>{{ $product->profile->user_type }}</li>
                <li class="uk-width-medium-1-3"><h5 class="uk-text-muted"><b>Brand Name</b></h5>{{$product->brand_name}}</li>
                <li class="uk-width-medium-1-3 uk-grid-margin"><h5 class="uk-text-muted"><b>Item Condition</b></h5>{{ $product->item_condition }}</li>
...
<section class="uk-container  uk-margin-large-top uk-margin-large-bottom">
    <h2>Other Electronics in this college</h2>
<div class="uk-grid tm-grid-truncate" data-uk-grid-margin="">
    @foreach($other_electronics as $other_electronic)
    <div class="uk-width-medium-1-3">
        <div class="uk-panel uk-panel-box uk-panel-box-secondary">
            <h3 class="uk-panel-title"><a href="{{ URL::route('getElectronicsDetails',$other_electronic->ad_title .'~'.$other_electronic->id)}}">{{$other_electronic->ad_title}}</a></h3>
            <p>Category: {{$other_electronic->category}}</p>
            <em><i class="uk-icon-rupee"></i> {{$other_electronic->selling_price}}/-</em>
            <a class="uk-align-right" href="{{ URL::route('getElectronicsDetails',$other_electronic->ad_title .'~'.$other_electronic->id)}}">VIEW</a>
        </div>
    </div>
    @endforeach
</div>
