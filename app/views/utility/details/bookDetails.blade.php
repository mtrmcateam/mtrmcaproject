...
@section('head')
@parent
<title>{{ $product->book_name }} | Mycollegeadda</title>
...
<section class="uk-container uk-container-center">
      ...
      <article class="uk-article uk-width-medium-8-10">
        <ul class="uk-breadcrumb">
            ...
            <li><a href="{{ URL::route('getBooksSearchQueryResult')}}">Books</a></li>
        ...
        <div class="uk-panel uk-panel-box uk-panel-box-secondary">
            ...
            <ul class="uk-grid uk-text-justify uk-container-center uk-width-9-10" data-uk-grid-margin="">
                <li class="uk-width-medium-1-3"><h5 style="margin-bottom:0px;" class="uk-text-muted"><b>SellingPrice</b></h5><i class="uk-icon-rupee"></i> {{$product->selling_price}}/-</li>
                <li class="uk-width-medium-1-3 uk-grid-margin"><h5 class="uk-text-muted"><b>MRP</b></h5><i class="uk-icon-rupee"></i> {{ $product->mrp }}/-</li>
                <li class="uk-width-medium-1-3"><h5 class="uk-text-muted"><b>Posted by</b></h5>{{ $product->profile->user_type }}</li>
                <li class="uk-width-medium-1-3"><h5 class="uk-text-muted"><b>Print Year</b></h5>{{$product->print_year}}</li>
                <li class="uk-width-medium-1-3 uk-grid-margin"><h5 class="uk-text-muted"><b>Author</b></h5>{{ $product->author_name }}</li>
                <li class="uk-width-medium-1-3 uk-grid-margin"><h5 class="uk-text-muted"><b>Book Condition</b></h5>{{ $product->book_condition }}</li>
                <li class="uk-width-medium-1-3 uk-grid-margin"><h5 class="uk-text-muted"><b>Book Edition</b></h5>{{$product->book_edition}}</li>
                <li class="uk-width-medium-1-3 uk-grid-margin"><h5 class="uk-text-muted"><b>ISBN</b></h5>{{ $product->isbn }}</li>
                <li class="uk-width-medium-1-3 uk-grid-margin"><h5 class="uk-text-muted"><b>Publisher</b></h5>{{ $product->publisher }}</li>
            </ul>
        </div>

        <div class="uk-panel uk-panel-box uk-panel-box-secondary">
            <h2 class="uk-margin-bottom">Book Description</h2>
...
<section class="uk-container  uk-margin-large-top uk-margin-large-bottom">
    <h2>Other books in this college</h2>
<div class="uk-grid tm-grid-truncate" data-uk-grid-margin="">
    @foreach($other_books as $other_book)
    <div class="uk-width-medium-1-3">
        <div class="uk-panel uk-panel-box uk-panel-box-secondary">
            <h3 class="uk-panel-title"><a href="{{ URL::route('getBooksDetails',$other_book->book_name .'~'.$other_book->id)}}">{{$other_book->book_name}}</a></h3>
            <p>Author: {{$other_book->author_name}}</p>
            <em><i class="uk-icon-rupee"></i> {{$other_book->selling_price}}/-</em>
            <a class="uk-align-right" href="{{ URL::route('getBooksDetails',$other_book->book_name .'~'.$other_book->id)}}">VIEW</a>
        </div>
    </div>
    @endforeach
</div>
